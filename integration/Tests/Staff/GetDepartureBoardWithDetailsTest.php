...
class GetDepartureBoardWithDetailsTest extends TestCase
{
    public function test_it_can_get_departures_for_location()
    {
        /** @var GetBoardWithDetailsResult $result */
        $result = clientFactory()->getDepartureBoardWithDetails(
            10,
            'MAC',
